# Precedentes usados pela banca (colhidos das peças protocoladas)

Ementas e teses efetivamente citadas em petições **protocoladas** pelo escritório
(Róger Bento — OAB/RS 98.365), extraídas da pasta
`ESCRITORIO/PEÇAS FINALIZADAS DR ALLAN/PROTOCOLADAS`.

## Status especial desta lista

- **USADO PELA BANCA** — precedente citado e protocolado pelo próprio escritório.
  Seguro para reuso **na mesma tese**, mas o advogado deve **conferir a
  vigência/atualidade** antes de novo protocolo. Ao reusar, transcrever a ementa
  exatamente como conferida; em dúvida, marcar `[CONFERIR TRANSCRIÇÃO]`.
- **Números de "Tema" vinculante citados pela banca entram como `[CONFERIR Nº]`** —
  a numeração de temas repetitivos é fácil de errar; confirmar antes de citar.

> Fonte de cada entrada = a peça protocolada de onde foi extraída (fonte mais
> confiável que temos, ainda sujeita a conferência de vigência).

---

## 1. Justa causa — reversão / ônus da prova

### TRT-2 — ROT 1001245-66.2023.5.02.0705
- **Tese:** Justa causa é penalidade máxima; exige prova robusta e inequívoca da
  falta grave, não bastam meros indícios. Ônus da reclamada (art. 818, II, CLT).
- **Dados:** Rel. Dulce Maria Soler Gomes Rijo, 3ª Turma, j. 26/08/2024.
- **Fonte:** "GRASIELA MARTINS – RECLAMAÇÃO". **Status:** USADO PELA BANCA.

## 2. Justa causa nula → dano moral

### TRT-4 — RORSUM 0020960-13.2020.5.04.0010
- **Tese:** Dispensa por justa causa macula a vida profissional; exige prova
  robusta (arts. 818 CLT e 373, II, CPC). Justa causa inválida causa abalo moral
  indelével quando demonstrada nulidade e abusividade — dano moral devido.
- **Dados:** 8ª Turma, j. 14/09/2021.
- **Fonte:** "GRASIELA MARTINS – RECLAMAÇÃO". **Status:** USADO PELA BANCA.
  **Precedente do TRT-4 — prioritário na região.**

## 3. Rescisão indireta (art. 483 da CLT)

### TRT-4 — ROT 0020126-85.2022.5.04.0124
- **Tese:** Atraso no pagamento de salários + ausência/irregularidade de FGTS
  configura falta grave patronal e enseja rescisão indireta (art. 483, "d").
- **Dados:** 8ª Turma, j. 28/06/2024.
- **Fonte:** "WILLIAN GABRIEL KROLOW KRAETZ – RECLAMAÇÃO". **Status:** USADO PELA
  BANCA. **Precedente do TRT-4 — prioritário na região.**

### TST — RR 0000305-47.2015.5.12.0018 (3054720155120018)
- **Tese:** Não recolher regularmente FGTS e atrasar pagamento de férias e
  salário configura ato faltoso grave suficiente para rescisão indireta (art.
  483, "d" e §3º). Comprovada a falta patronal, presume-se o nexo com a
  iniciativa do empregado.
- **Dados:** Rel. Augusto Cesar Leite de Carvalho, 6ª Turma, j. 28/04/2021, pub.
  14/05/2021.
- **Fonte:** "WILLIAN GABRIEL KROLOW KRAETZ – RECLAMAÇÃO". **Status:** USADO PELA
  BANCA. **Precedente do TST.**

### TRT-3 — RO 0010177-31.2017.5.03.0030
- **Tese:** Descumprimento de obrigações contratuais + exposição do empregado a
  perigo manifesto de mal considerável (não observância de normas de meio
  ambiente de trabalho saudável) enseja rescisão indireta (art. 483, "c" e "d").
- **Dados:** Rel. Emerson José Alves Lage, 1ª Turma.
- **Fonte:** "GEISON RAFAEL ARAUJO DOS SANTOS – RECLAMAÇÃO". **Status:** USADO
  PELA BANCA.

## 4. Insalubridade / EPI

### TRT-2 — ROT 1000141-32.2022.5.02.0072
- **Tese:** Insalubridade por ruído — não basta alegar entrega de protetor
  auricular por prova oral; exige prova **documental** (CA, atenuação, vida útil
  — NR-6). Ausente, prevalece o laudo pericial.
- **Dados:** Rel. Moisés dos Santos Heitor, 1ª Turma.
- **Fonte:** "FERNANDO RONIEL DA LUZ DUARTE – RECLAMAÇÃO". **Status:** USADO PELA
  BANCA.

### TRT-3 — RO 0010733-40.2020.5.03.0026
- **Tese:** Para se eximir do adicional de insalubridade não basta afirmar que
  forneceu EPI; é necessária prova do uso efetivo e ficha de fornecimento (CA/
  aprovação MTE).
- **Dados:** Rel. Manoel Barbosa da Silva, 5ª Turma, j. 01/10/2021, pub.
  04/10/2021.
- **Fonte:** "EMERSON CRISTIANO AVILA DA ROSA – RECLAMAÇÃO". **Status:** USADO
  PELA BANCA.

### TRT-4 — ROT 0020365-46.2018.5.04.0022
- **Tese:** Contato com cimento (calcário, argila, minério de ferro, gesso —
  compostos químicos da FISPQ) enseja insalubridade **grau médio** (NR-15, Anexo
  13).
- **Dados:** 11ª Turma, pub. 19/10/2020.
- **Fonte:** "EMERSON CRISTIANO AVILA DA ROSA – RECLAMAÇÃO". **Status:** USADO
  PELA BANCA. **Precedente do TRT-4 — prioritário na região.**

## 5. Dano moral — hipóteses diversas

### TST — RR 0010351-94.2023.5.03.0041
- **Tese:** Ausência de fornecimento de EPI a exposto a agente nocivo → dano
  moral **in re ipsa** (art. 5º, X, CF; arts. 186 e 187 CC). Indenização R$
  10.000.
- **Dados:** Rel. José Roberto Freire Pimenta, 3ª Turma, j. 17/09/2025, pub.
  30/09/2025.
- **Fonte:** "FERNANDO RONIEL – RECLAMAÇÃO". **Status:** USADO PELA BANCA. **TST.**

### TRT-4 — ROT 0020285-97.2023.5.04.0122
- **Tese:** Ausência de EPI em atividade insalubre → violação ao dever de
  proteção patronal, dano moral indenizável.
- **Dados:** 8ª Turma, j. 16/03/2026.
- **Fonte:** "FERNANDO RONIEL – RECLAMAÇÃO". **Status:** USADO PELA BANCA.
  **Precedente do TRT-4 — prioritário na região.**

### TST — RR 0000298-19.2016.5.17.0006 (2981920165170006)
- **Tese:** Ausência de banheiro/instalações sanitárias no local de trabalho é
  condição degradante que ofende a dignidade (art. 1º, III, CF; NR-24) → dano
  moral.
- **Dados:** Rel. Alexandre de Souza Agra Belmonte, 3ª Turma, j. 16/10/2019, pub.
  18/10/2019.
- **Fonte:** "WILLIAN GABRIEL – RECLAMAÇÃO". **Status:** USADO PELA BANCA. **TST.**

### TST — RR 0100865-77.2017.5.01.0003 (01008657720175010003)
- **Tese:** Atraso reiterado no pagamento de salários gera dano moral **in re
  ipsa** (art. 5º, X, CF), pela natureza alimentar da parcela.
- **Dados:** Rel. Alexandre de Souza Agra Belmonte, 8ª Turma, j. 25/10/2022, pub.
  03/11/2022.
- **Fonte:** "WILLIAN GABRIEL – RECLAMAÇÃO". **Status:** USADO PELA BANCA. **TST.**

### TRT-4 — ROT 0020309-43.2025.5.04.0741
- **Tese:** Ameaça proferida pelo empregador via WhatsApp após ajuizamento de
  ação configura ato ilícito e dano moral (BO + mensagens como prova). Indenização
  R$ 3.000 no caso.
- **Dados:** 4ª Turma, j. 25/02/2026.
- **Fonte:** "EMERSON CRISTIANO – RECLAMAÇÃO". **Status:** USADO PELA BANCA.
  **Precedente do TRT-4 — prioritário na região.**

### TRT-17 — RO 0001144-15.2016.5.17.0013
- **Tese:** Destratos, xingamentos e ameaça pelo empregador → dano moral
  (patrimônio extrapatrimonial / direitos da personalidade).
- **Dados:** Rel. Des. Ana Paula Tauceda Branco, j. 25/02/2019, pub. 08/03/2019.
- **Fonte:** "EMERSON CRISTIANO – RECLAMAÇÃO". **Status:** USADO PELA BANCA.

### TRT-3 — RO 0010089-05.2020.5.03.0089
- **Tese:** Ausência de anotação da CTPS é conduta antijurídica que coloca o
  trabalhador na clandestinidade (à margem do sistema trabalhista-previdenciário)
  → dano moral **in re ipsa**.
- **Dados:** Rel. Emerson José Alves Lage, 1ª Turma, j. 05/05/2021, pub.
  07/05/2021.
- **Fonte:** "EMERSON CRISTIANO – RECLAMAÇÃO". **Status:** USADO PELA BANCA.

## 6. Direito de desconexão

### TRT-5 — ROT 0000180-03.2022.5.05.0221
- **Tese:** Acionamento habitual do empregado fora do expediente por WhatsApp
  para tratar de trabalho viola o direito de desconexão (arts. 6º e 7º, XIII e
  XV, CF) → dano moral.
- **Dados:** Rel. Edilton Meireles de Oliveira Santos, 1ª Turma.
- **Fonte:** "GEISON RAFAEL – RECLAMAÇÃO". **Status:** USADO PELA BANCA.

---

## 7. Teses vinculantes (Temas) citadas pela banca — CONFERIR NÚMERO

O escritório invoca estes "Temas" repetitivos. **Números a conferir** antes de
citar (a numeração muda de fonte para fonte e é fácil errar):

- **Tema 21 do TST** — declaração de pessoa natural é meio idôneo à comprovação
  da hipossuficiência (justiça gratuita). `[CONFERIR Nº]`
- **Tema 70 do TST** — irregularidade no recolhimento do FGTS autoriza rescisão
  indireta, independentemente de imediatidade. `[CONFERIR Nº]`
- **Tema 9 do TST** — reflexos do RSR majorado por horas extras nas demais
  parcelas, para horas prestadas após 20/03/2023 (relacionado à antiga OJ 394 da
  SDI-1). `[CONFERIR Nº e marco temporal]`
- **Tema 52 do TST** — multa do art. 477, §8º, devida na rescisão indireta.
  `[CONFERIR Nº]`
- **Tema 142 do TST** — base da multa do art. 477 abrange todas as parcelas
  salariais, não só o salário-base. `[CONFERIR Nº]`
- **Tema 103 do TST** — atraso reiterado no pagamento de salários gera dano moral
  in re ipsa. `[CONFERIR Nº]`
- **Tema 1.046 do STF** — validade de normas coletivas que limitam/afastam
  direitos, respeitados os absolutamente indisponíveis. (Ver também
  `teses-repetitivas-irr.md`.) `[CONFERIR]`
- **Súmula 51, I, do TST** — alteração de regulamento interno não atinge direitos
  de quem já era empregado. `[CONFERIR]`

> **Regra:** ao usar qualquer "Tema" numa peça nova, confirmar o número e o teor
> antes do protocolo; se não confirmado, citar a tese descritivamente + lei, sem
> afirmar o número.
